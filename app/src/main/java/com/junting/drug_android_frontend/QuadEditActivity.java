...
public class QuadEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mImageEditView.setOriginalImage(TakePhotoActivity.mImageData);
        ...
        for (DetectedQuadResult r : TakePhotoActivity.mQuadResults) {
    ...
    public void onNormalizeBtnClick(View v) {
        try {
            ...
            if(item instanceof QuadDrawingItem) {
                ...
                mNormalizedImageResult = TakePhotoActivity.mNormalizer.normalize(TakePhotoActivity.mImageData, ((QuadDrawingItem) item).getQuad());
